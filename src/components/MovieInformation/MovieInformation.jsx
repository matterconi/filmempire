...
import { Grid, Typography, Button, ButtonGroup, Box, CircularProgress, Rating } from '@mui/material';
import { 
  StyledOuterGrid, 
  StyledGrid, 
  StyledImg, 
    ...
    <StyledOuterGrid container>
      ...
      <Box marginTop="5rem" width="100%">
          ...
          {recommendedMovies
            ...
            numberOfMovies={12} isRecommended={true}
            />
            : <Typography>No recommended movies found</Typography>}
      </Box>
      {data?.videos?.results.length > 0 && <StyledModal
